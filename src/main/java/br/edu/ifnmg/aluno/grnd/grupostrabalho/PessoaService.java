...
//</editor-fold>
    ...
    public List<Grupo> findGruposPorLider(String nomeLider) {
        String query = "SELECT g FROM Pessoa p, IN (p.liderGrupos) g WHERE p.nome = :nomeLider";
        return (List<Grupo>) entityManager
                .createQuery(query)
...
//</editor-fold>
    ...
    public List<Object[]> findDatasAtuacaoGrupo(String nomeMembro) {
        String query = "SELECT g.nome, a.inicio, a.termino FROM Grupo g, IN (g.atuacao) a WHERE a.pessoa.nome = :nomeMembro";
...
//</editor-fold>
    ...
    public List<Object[]> findNomeGrupoQuantidadeMembros() {
        String query = "SELECT g.nome, COUNT(DISTINCT a.pessoa.id) FROM Grupo g, IN (g.atuacao) a GROUP BY g.nome";
        return (List<Object[]>) entityManager
                .createQuery(query)
                .getResultList();
    }
//</editor-fold>
    ...
    public List<Object[]> findNomeGrupoPorTotalAtuacoes(Long total) {
        String query = "SELECT g.nome, COUNT(a.id) FROM Grupo g, IN (g.atuacao) a GROUP BY g.nome HAVING COUNT(a.id) >= :total";
        return (List<Object[]>) entityManager
                .createQuery(query)
...
//</editor-fold>
    ...
    public List<MembroDto> findMembroDto(LocalDate dataInicio) {
        String query = "SELECT new br.edu.ifnmg.aluno.grnd.grupostrabalho.MembroDto(a.grupo.nome, a.inicio, a.pessoa.nome) FROM Atuacao a WHERE a.inicio >= :dataInicio";
